...
\title{Bias beperken bij AI-gedreven aanwerving: een afwegingskader van technische en organisatorische maatregelen}
...
\begin{abstract}
  ...
  ras en geslacht reproduceren of versterken, onder meer doordat ze getraind
  worden op beperkte of onevenwichtige data en vooroordelen van ontwerpers
  overnemen. Dit onderzoeksvoorstel onderzoekt welke combinatie van
  technische en organisatorische maatregelen (bias-audits, transparante
  scoringscriteria en menselijk toezicht op automatische afwijzingen) het
  meest geschikt is om discriminatie van sollicitanten door AI-gedreven
  aanwervingsplatformen te beperken, zonder de efficiëntiewinst van
  geautomatiseerde screening significant te verminderen. Op basis van een
  literatuurstudie wordt eerst het probleem- en oplossingsdomein afgebakend.
  Vervolgens worden de drie maatregelen in een eigen proof-of-concept
  vergelijkend getest, gebruikmakend van de dataset en naamvervangingsmethode
  van Wilson en Caliskan (2024): voor een vaste steekproef van
  cv-vacature-paren wordt telkens enkel de kandidaatsnaam vervangen door een
  naam die statistisch geassocieerd wordt met een specifieke combinatie van
  ras en geslacht, waarna een tekst-embeddingmodel de cv's rangschikt onder
  vier condities (baseline, bias-audit met terugkoppeling, transparante
  scoringscriteria en menselijk toezicht). Per conditie wordt gemeten in
  welke mate naamvarianten geassocieerd met een blanke of mannelijke
  kandidaat bevoordeeld worden, hoeveel de rangschikkingspositie verschuift,
  en wat de doorlooptijd van elke maatregel is. Verwacht wordt dat de
  baseline een meetbare bias ten voordele van blanke en mannelijke
  naamvarianten vertoont, en dat elke maatregel deze bias in verschillende
  mate terugdringt, mogelijk ten koste van een langere doorlooptijd, zodat
  geen enkele maatregel bias volledig wegneemt zonder afweging met
  efficiëntie. Het onderzoek moet zo resulteren in
  een onderbouwd afwegingskader voor werkgevers die een
  AI-aanwervingsplatform zoals dat van Workday of Eightfold AI inzetten, om
  discriminatierisico's te beperken zonder de efficiëntiewinst van
  geautomatiseerde screening volledig op te geven.
\end{abstract}
